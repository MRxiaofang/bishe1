...
$link=connect1();
$sh="UPDATE mianfei SET checkstate=1 where id=$id";
$shc=mysqli_query($link,$sh);
if($shc){
	echo "<script>alert('该信息已经通过审核');window.location.href='findfreeinfo.php?checkstate=$checkstate&type=$type';</script>";
}else{
