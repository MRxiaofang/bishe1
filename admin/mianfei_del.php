...
$link=connect1();
$de="delete from mianfei where id=$id";
$del=mysqli_query($link,$de);
if($del){
	echo"<script>alert('您已成功删除该条信息');window.location.href='findfreeinfo.php?checkstate=$checkstate&type=$type';</script>";
}else{
