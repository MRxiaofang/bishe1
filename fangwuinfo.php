...
$htj="select count(*) as totalRows from mianfei where type='房屋信息' and checkstate=1";
			...
			<table width="563" border="0" cellspacing="0" cellpadding="0" height="593">
				...
				<tr>
					<td width="563" height="160">
						<?php
							$date1=date("Y-m-d");
							$ss="select * from fufei where type='房屋信息' and showday>='$date1' and checkstate=1";  //查找当天发布的信息并且已经检查是否发布
						...
						<table width="563" border="0" height="130">
							<tr>
								<td align="center" style="font-weight:bold;font-size:25px;color:red">暂无房屋信息！</td>				<!--已经输出-->
							</tr>
						</table>
						<?php
							}else{
				...
				<tr>																<!---第二部分排版-->
					<td width="563" height="337">
						<?php
							$date2=date("Y-m-d");
							$sg="select * from mianfei where type='房屋信息' and checkstate=1 limit {$offet},{$pagesize}";//查找当天发布的信息并且已经检查是否发布
						...
						<table width="540" height="335" border="0" cellspacing="0">
							<tr>
								<td align="center"><a style="font-weight:bold;font-size:25px;color:red">暂无房屋信息！</a></td>    		<!--无法输出-->  
							</tr>
						</table>
						<?php
							...
							<tr>
								<td width="540" border="0" height="40" id="fuji">
									<ul id="fanye">
										<?php
											for($i = 1;$i<=$sumpage;$i++){
												echo "<li><a href='fangwu.php?page={$i}'>$i</a></li>";
													}
										?>
									</ul>	
								</td>
